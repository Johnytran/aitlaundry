...
class LocationModelLocations extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		if (!JFactory::getUser()->authorise('core.edit', 'com_location'))
		{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.suburbname LIKE ' . $search . ' )');
			}
		}
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_LOCATION_SEARCH_FILTER_DATE_FORMAT"), "warning");
