...
$document->addStyleSheet(JUri::root() . 'media/com_userextra/css/form.css');
?>
...
<form
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_USEREXTRA_TITLE_USER', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('homephone'); ?>
