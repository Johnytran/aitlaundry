...
/**
 * View class for a list of Combos.
 *
 * @since  1.6
 */
class CombosViewCombos extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		CombosHelpersCombos::addSubmenu('combos');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_COMBOS_TITLE_COMBOS'), 'combos.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('combos.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		{
			JToolBarHelper::preferences('com_combos');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_combos&view=combos');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_COMBOS_COMBOS_NAME'),
