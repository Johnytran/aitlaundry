...
$document->addStyleSheet(JUri::root() . 'media/com_order/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_order&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="order-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_ORDER_TITLE_ORDER', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('datetimecreated'); ?>
				<?php echo $this->form->renderField('addresspickup'); ?>
				<?php echo $this->form->renderField('date_timepickup'); ?>
				<?php echo $this->form->renderField('addressdelivery'); ?>
				<?php echo $this->form->renderField('date_timedelivery'); ?>
				<?php echo $this->form->renderField('deliverynote'); ?>
