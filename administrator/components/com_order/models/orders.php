	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'addresspickup', 'a.`addresspickup`',
				'date_timepickup', 'a.`date_timepickup`',
				'addressdelivery', 'a.`addressdelivery`',
				'date_timedelivery', 'a.`date_timedelivery`',
