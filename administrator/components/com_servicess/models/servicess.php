...
/**
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Filtering comboid
		$this->setState('filter.comboid', $app->getUserStateFromRequest($this->context.'.filter.comboid', 'filter_comboid', '', 'string'));


		// Load the parameters.
		$params = JComponentHelper::getParams('com_servicess');
	...
	protected function getListQuery()
	{
		...
		if ($filter_comboid !== null && !empty($filter_comboid))
		{
