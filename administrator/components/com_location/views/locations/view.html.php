...
/**
 * View class for a list of Location.
 *
 * @since  1.6
 */
class LocationViewLocations extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		LocationHelpersLocation::addSubmenu('locations');
	...
	protected function addToolbar()
	{
		...
		$canDo = LocationHelpersLocation::getActions();

		JToolBarHelper::title(JText::_('COM_LOCATION_TITLE_LOCATIONS'), 'locations.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_location&view=locations');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`postcode`' => JText::_('COM_LOCATION_LOCATIONS_POSTCODE'),
			'a.`suburbname`' => JText::_('COM_LOCATION_LOCATIONS_SUBURBNAME'),
