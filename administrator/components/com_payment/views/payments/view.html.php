...
class PaymentViewPayments extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		PaymentHelpersPayment::addSubmenu('payments');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PAYMENT_TITLE_PAYMENTS'), 'payments.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_payment&view=payments');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`type`' => JText::_('COM_PAYMENT_PAYMENTS_TYPE'),
			'a.`ordering`' => JText::_('JGRID_HEADING_ORDERING'),
			'a.`state`' => JText::_('JSTATUS'),
			'a.`created_by`' => JText::_('COM_PAYMENT_PAYMENTS_CREATED_BY'),
			'a.`modified_by`' => JText::_('COM_PAYMENT_PAYMENTS_MODIFIED_BY'),
		);
	}
}
