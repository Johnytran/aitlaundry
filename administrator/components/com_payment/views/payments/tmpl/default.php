...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_payment/assets/css/payment.css');
$document->addStyleSheet(JUri::root() . 'media/com_payment/css/list.css');
...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_payment&task=payments.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_payment&view=payments'); ?>" method="post"
			...
			<table class="table table-striped" id="paymentList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PAYMENT_PAYMENTS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PAYMENT_PAYMENTS_TYPE', 'a.`type`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PAYMENT_PAYMENTS_CREATED_BY', 'a.`created_by`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PAYMENT_PAYMENTS_MODIFIED_BY', 'a.`modified_by`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_payment&task=payment.edit&id='.(int) $item->id); ?>">
