...
class PaymentViewPayment extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		$canDo = PaymentHelpersPayment::getActions();

		JToolBarHelper::title(JText::_('COM_PAYMENT_TITLE_PAYMENT'), 'payment.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_payment.payment', $this->item->id);
		}
