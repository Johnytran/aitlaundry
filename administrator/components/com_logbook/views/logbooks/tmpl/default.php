...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_logbook/assets/css/logbook.css');
$document->addStyleSheet(JUri::root() . 'media/com_logbook/css/list.css');

$user      = JFactory::getUser();
$userId    = $user->get('id');
$listOrder = $this->state->get('list.ordering');
$listDirn  = $this->state->get('list.direction');
$canOrder  = $user->authorise('core.edit.state', 'com_logbook');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_logbook&task=logbooks.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'logbookList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="logbookList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canCreate  = $user->authorise('core.create', 'com_logbook');
					$canEdit    = $user->authorise('core.edit', 'com_logbook');
